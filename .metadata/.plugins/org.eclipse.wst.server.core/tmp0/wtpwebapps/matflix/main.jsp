...
<body>
	...
	<div class="mybox sticky-top">
		...
		<nav class="navbar navbar-expand-lg navbar-light container">
			<!-- 로고 작성 -->
			<a class="navbar-brand" id="logo3" href=""> <img
				src="resources/main/images/mlogo.png" alt="" style="width:70px;">
				<p></p>
			</a>
				...
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="/b_loading.jsp">자유 게시판</a> <a
								class="dropdown-item" href="/board2/list">공지사항 게시판</a> <a
	...
	<div id="wrapper" data-spy="scroll" data-target="#navbar-example2"
		...
		<h1 class="guro">Franchise in Guro</h1>
         ...
         <button>&times;</button>
         <div class="modalBox1">
         <img src="resources/main/images/mat-1.jpg" style="width:600px;">
         <p></p>
      </div>
            </div>
          ...
          <div class="owl-carousel owl-theme">
            <div class="item">
              <a href="resources/main/images/m1.jpg"><img src="resources/main/images/m1.jpg" style="width:300px;"></a>
            </div>
            <div class="item">
              <a href="resources/main/images/m2.jpg"><img src="resources/main/images/m2.jpg" style="width:300px;"></a>
            </div>
            <div class="item">
              <a href="resources/main/images/m3.jpg"><img src="resources/main/images/m3.jpg" style="width:300px;"></a>
            </div>
            <div class="item">
              <a href="resources/main/images/m4.jpg"><img src="resources/main/images/m4.jpg" style="width:300px;"></a>
            </div>
            <div class="item">
              <a href="resources/main/images/m5.jpg"><img src="resources/main/images/m5.jpg" style="width:300px;"></a>
            </div>
            <div class="item">
              <a href="resources/main/images/m6.jpg"><img src="resources/main/images/m6.jpg" style="width:300px;"></a>
            </div>
            <div class="item">
              <a href="resources/main/images/m7.jpg"><img src="resources/main/images/m7.jpg" style="width:300px;"></a>
            </div>
            <div class="item">
              <a href="resources/main/images/m8.jpg"><img src="resources/main/images/m8.jpg" style="width:300px;"></a>
            </div>
            </div>
			...
			<div id="carouselExampleCaptions" class="carousel slide container"
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<a href="resources/main/images/res5.jpg"><img src="resources/main/images/res5.jpg" class="d-block w-100"
							alt="도시1"></a>
					</div>
					<div class="carousel-item">
						<a href="resources/main/images/res2.jpg"><img src="resources/main/images/res2.jpg" class="d-block w-100"
							alt="도시2"></a>
					</div>
					<div class="carousel-item">
						<a href="resources/main/images/res3.jpg"><img src="resources/main/images/res3.jpg" class="d-block w-100"
							alt="도시3"></a>
					</div>
					<div class="carousel-item">
						<a href="resources/main/images/res4.png"><img src="resources/main/images/res4.png" class="d-block w-100"
							alt="도시4"></a>
					</div>
				</div>
