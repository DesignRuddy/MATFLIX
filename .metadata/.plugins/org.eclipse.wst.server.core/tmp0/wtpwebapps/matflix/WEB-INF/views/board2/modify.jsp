            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                      ...
                      <form action="/board2/modify" method="post" role="form">      
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                          <label>Title</label>
                          <input class="form-control" name="title" value='<c:out value="${board2.title}" />'>                       
                       </div>                       
                       <div class="form-group">
                          <label>Content</label>
                          <textarea class="form-control" rows="3" name="content"><c:out value="${board2.content}" /></textarea>
                       </div>
                       <div class="form-group">
                          <label>Writer</label>
                       ...
                       <div class="form-group" style="display: none;">
                          <label>RegDate</label>
                          <input class="form-control" name="regdate" value='<fmt:formatDate value="${board2.regdate}" pattern="yyyy/MM/dd" />' readonly="readonly">                                                
                       </div>  
                       <div class="form-group" style="display: none;">
                          <label>UpdateDate</label>
                          <input class="form-control" name="updateDate" value='<fmt:formatDate value="${board2.updateDate}" pattern="yyyy/MM/dd" />' readonly="readonly">                                                
                       </div>                        
                       
                       <!-- Page719 현재 로그인한 사용자가 게시물의 작성자인 경우에만 수정과 삭제가 가능하도록 아래처럼 소스 코딩합니다. -->
